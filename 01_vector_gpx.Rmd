...
Let's use an example file that lives [here on github](https://raw.githubusercontent.com/ryanpeek/mapping-in-R-workshop/master/data/NFA.GPX) on github. Download the file, and save it into a `data` folder. 
...
trax <- st_read(file1, layer = "tracks")
...
file1url <- "https://raw.githubusercontent.com/ryanpeek/r_officehours/master/data/NFA.GPX"
...
# pull a single track
trx1 <- trax %>% filter(name=="2017-05-05-NFA")
