...
h8_tahoe <- st_read("data/h8_tahoe.shp", quiet=TRUE) # HUC8 watershed for Tahoe
lakes <- st_read("data/lakes_CA_OR_hydroshed.shp", quiet=TRUE) # Lakes for all of CA/OR from HydroSHEDS
rivers <- st_read("data/rivs_CA_OR_hydroshed.shp", quiet=TRUE) # Rivers for all of CA/OR from HydroSHEDS
